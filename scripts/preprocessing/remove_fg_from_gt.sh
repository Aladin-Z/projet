...
python3 -m cityscapesscripts.preparation.createTrainIdLabelImgs

in_dir='data/cityscapes/gtFine/train/'
out_dir='data/cityscapes/gtFine_nofg/train'
python3 -u scripts/preprocessing/remove_fg_from_gt.py --input_dir $in_dir --output_dir $out_dir
